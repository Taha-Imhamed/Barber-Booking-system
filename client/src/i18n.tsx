...
const dictionary: Dictionary = {
  ...
  adminControl: { en: "Admin Control", tr: "Yonetici Kontrol", sq: "Kontrolli i Adminit" },
  dashboardTheme: { en: "Dashboard Theme", tr: "Panel Temasi", sq: "Tema e Panelit" },
  selectTheme: { en: "Select theme", tr: "Tema sec", sq: "Zgjidh temen" },
  barberPortal: { en: "Barber Portal", tr: "Berber Portali", sq: "Portali i Berberit" },
  pending: { en: "Pending", tr: "Bekliyor", sq: "Ne pritje" },
  upcoming: { en: "Upcoming", tr: "Yaklasan", sq: "Ne ardhje" },
  accepted: { en: "Accepted", tr: "Kabul Edildi", sq: "Pranuar" },
  fullTimetable: { en: "Full Timetable", tr: "Tam Zaman Cizelgesi", sq: "Orari i plote" },
  gallery: { en: "Gallery", tr: "Galeri", sq: "Galeria" },
  groupChat: { en: "Group Chat", tr: "Grup Sohbet", sq: "Biseda ne grup" },
  manageBranches: { en: "Manage Branches", tr: "Subeleri Yonet", sq: "Menaxho degat" },
  openMap: { en: "Open Map", tr: "Haritayi Ac", sq: "Hap Hartan" },
  addBranch: { en: "Add Branch", tr: "Sube Ekle", sq: "Shto dege" },
  branchName: { en: "Branch name", tr: "Sube adi", sq: "Emri i deges" },
  locationLabel: { en: "Location", tr: "Konum", sq: "Vendndodhja" },
  googleMapsLink: { en: "Google Maps link", tr: "Google Maps linki", sq: "Lidhja Google Maps" },
  detectFromLink: { en: "Detect from link", tr: "Linkten tespit et", sq: "Zbulo nga lidhja" },
  latitudeLabel: { en: "Latitude", tr: "Enlem", sq: "Gjeresia" },
  longitudeLabel: { en: "Longitude", tr: "Boylam", sq: "Gjatesia" },
  openInGoogleMaps: { en: "Open in Google Maps", tr: "Google Maps'te ac", sq: "Hap ne Google Maps" },
  barbersBranches: { en: "Barbers & Branches", tr: "Berberler ve Subeler", sq: "Berberet dhe degat" },
  servicesLabel: { en: "Services", tr: "Hizmetler", sq: "Sherbimet" },
  reportsLabel: { en: "Reports", tr: "Raporlar", sq: "Raportet" },
  financeLabel: { en: "Finance", tr: "Finans", sq: "Financa" },
  wallDisplayLabel: { en: "Wall Display", tr: "Ekran", sq: "Ekrani i murit" },
  usersLabel: { en: "Users", tr: "Kullanicilar", sq: "Perdoruesit" },
  growthOpsLabel: { en: "Growth & Ops", tr: "Buyume ve Operasyon", sq: "Rritje & Operacione" },
  developerLabel: { en: "Developer", tr: "Gelistirici", sq: "Zhvillues" },
  changePassword: { en: "Change password", tr: "Sifre degistir", sq: "Ndrysho fjalekalimin" },
  newPassword: { en: "New password", tr: "Yeni sifre", sq: "Fjalekalim i ri" },
  confirmPassword: { en: "Confirm password", tr: "Sifreyi onayla", sq: "Konfirmo fjalekalimin" },
  savePassword: { en: "Save password", tr: "Sifreyi kaydet", sq: "Ruaj fjalekalimin" },
  passwordMismatch: { en: "Passwords do not match.", tr: "Sifreler eslesmiyor.", sq: "Fjalekalimet nuk perputhen." },
  passwordTooShort: { en: "Password too short.", tr: "Sifre cok kisa.", sq: "Fjalekalimi shume i shkurter." },
  passwordUpdated: { en: "Password updated.", tr: "Sifre guncellendi.", sq: "Fjalekalimi u perditesua." },
};
